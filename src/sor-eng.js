...
function(){return ''+'<span class="num">10: </span>'+'Fire Damage: '+(dec(dec(dec((ln(lvl(36),6,3,4,8,18,54)<<7)*(100+((blvl(47)+blvl(56))*16))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/256,0))+'-'+(dec(dec(dec((ln(lvl(36),12,3,6,10,20,56)<<7)*(100+((blvl(47)+blvl(56))*16))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/256,0))+'<br>'
},
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((5<<7)/256,1),'<br>'])
},
...
function(){return ''+'<span class="num">7: </span>'+dec((30+(lvl(37)-1)*12),0)+' percent<br>'
},
function(){return ''},
...
function(){return ''+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(dec(dec((ln(lvl(38),4,1,1,2,3,4)<<7)*(100+((blvl(49))*6))/100,0)*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'-'+(dec(dec(dec((ln(lvl(38),8,1,1,2,3,4)<<7)*(100+((blvl(49))*6))/100,0)*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'<br>'
+'<span class="num">7: </span>'+dec(min(24,(3+(lvl(38)-1))),0)+' bolts<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((24+(lvl(38)-1)*4)<<5,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">11: </span>'+cc(['Cold Length: ',dec(dec((150+(lvl(39)-1)*35),0)/25,1),' seconds<br>'])
...
function(){return ''+'<span class="num">3: </span>'+'Defense Bonus: '+dec((30+(lvl(40)-1)*5),0)+' percent<br>'
+'<span class="num">12: </span>'+cc(['Duration: ',dec(((3000+(lvl(40)-1)*300)+(blvl(50)+blvl(60))*250)/25,1),' seconds<br>'])
+'<span class="num">12: </span>'+cc(['Freezes for ',dec(((30+(lvl(40)-1)*3)*(100+((blvl(50)+blvl(60))*5))/100)/25,1),' seconds<br>'])
...
function(){return ''+'<span class="num">26: </span>'+'Average Fire Damage: '+(dec(dec(dec((ln(lvl(41),32,24,26,28,32,36)<<2)*(100+((blvl(37))*13))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/10.24,0))+'-'+(dec(dec(dec((ln(lvl(41),64,24,27,29,33,37)<<2)*(100+((blvl(37))*13))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/10.24,0))+' per second<br>'
+'<span class="num">19: </span>'+'Range: '+dec(dec((20+(lvl(41)-1)*3)/4,0)*2/3,1)+' yards<br>'
+'<span class="num">3: </span>'+'Mana Cost: '+dec(dec(max((36+(lvl(41)-1))<<2,0)/20.48,0),0)+' per second<br>'
},
...
function(){return ''+'<span class="num">19: </span>'+'Radius: '+dec(dec((5+(lvl(42)-1)),0)*2/3,1)+' yards<br>'
...
function(){return ''+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(dec(dec((lvl(43)<<8),0)*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'-'+(dec(dec(dec(((2+(lvl(43)-1))<<8),0)*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((7<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">11: </span>'+cc(['Cold Length: ',dec(dec((200+(lvl(44)-1)*25),0)/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((9+(lvl(44)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">12: </span>'+cc(['Freezes for ',dec((dec((75+(lvl(45)-1)*5)*(100+((blvl(55))*10))/100,0))/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((12+(lvl(45)-1))<<7,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">23: </span>'+cc(['Fire Duration: ',dec(((90+(lvl(46)-1)*25))/25,1),' seconds<br>'])
+'<span class="num">27: </span>'+'Average Fire Damage: '+(dec(dec(dec((ln(lvl(46),4,2,3,4,6,9)<<4),0)*(100+(30+(lvl(61)-1)*7))/100,0)*75/256,0))+'-'+(dec(dec(dec((ln(lvl(46),8,2,3,4,6,9)<<4),0)*(100+(30+(lvl(61)-1)*7))/100,0)*75/256,0))+' per second<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((22+(lvl(46)-1))<<7,1<<8)/256,1),'<br>'])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},3,1]
desc[47]=['Fire Ball',
'creates an explosive sphere of fiery death<br>to engulf your enemies',
function(){return ''+'<span class="num">10: </span>'+'Fire Damage: '+(dec(dec(dec((ln(lvl(47),12,13,23,28,33,38)<<7)*(100+((blvl(36)+blvl(56))*14))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/256,0))+'-'+(dec(dec(dec((ln(lvl(47),28,15,25,30,35,40)<<7)*(100+((blvl(36)+blvl(56))*14))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((10+(lvl(47)-1))<<7,1<<8)/256,1),'<br>'])
},
...
function(){return ''+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(dec(dec((ln(lvl(48),1,6,7,8,9,10)<<8),0)*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'-'+(dec(dec(dec((ln(lvl(48),20,8,9,10,11,12)<<8),0)*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((15+(lvl(48)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},3,1]
desc[49]=['Lightning',
'creates a powerful lightning bolt<br>to lay waste to your enemies',
function(){return ''+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(dec(256*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'-'+(dec(dec(dec((ln(lvl(49),40,8,12,20,28,36)<<8)*(100+((blvl(38)+blvl(53)+blvl(48))*8))/100,0)*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((16+(lvl(49)-1))<<7,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec(((3000+(lvl(50)-1)*300)+(blvl(40)+blvl(60))*250)/25,1),' seconds<br>'])
+'<span class="num">3: </span>'+'Defense Bonus: '+dec((45+(lvl(50)-1)*6),0)+' percent<br>'
...
function(){return ''+'<span class="num">30: </span>'+cc(['Fire Duration: ',dec(90/25,1),' seconds<br>'])
+'<span class="num">27: </span>'+'Average Fire Damage: '+(dec(dec(dec((ln(lvl(51),15,9,14,21)<<4),0)*(100+(30+(lvl(61)-1)*7))/100,0)*75/256,0))+'-'+(dec(dec(dec((ln(lvl(51),20,9,14,21)<<4),0)*(100+(30+(lvl(61)-1)*7))/100,0)*75/256,0))+' per second<br>'
+'<span class="num">29: </span>'+cc([dec(dec((7+(lvl(51)-1)*2),0)*2/3,1),' yards<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((22+(lvl(51)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec(((3600+(lvl(52)-1)*600))/25,1),' seconds<br>'])
+'<span class="num">10: </span>'+'Fire Damage: '+(dec(dec(dec((ln(lvl(52),16,3,7,11,15,19)<<7)*(100+((blvl(37))*9))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/256,0))+'-'+(dec(dec(dec((ln(lvl(52),20,5,9,13,17,21)<<7)*(100+((blvl(37))*9))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/256,0))+'<br>'
+'<span class="num">2: </span>'+cc(['Attack Bonus: ',sign(dec((20+(lvl(52)-1)*9),0)),' percent<br>',])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((25+(lvl(52)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">7: </span>'+dec((26+(lvl(53)-1))/5,0)+' hits<br>'
+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(dec(256*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'-'+(dec(dec(dec((ln(lvl(53),40,11,13,15)<<8)*(100+((blvl(38)+blvl(49)+blvl(48))*4))/100,0)*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((9+(lvl(53)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((24+(lvl(54)-1)*-1)<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">12: </span>'+cc(['Freezes for ',dec(((50+(lvl(55)-1)*3)*(100+blvl(59)*3)/100)/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((20+(lvl(55)-1))<<7,1<<8)/256,1),'<br>'])
},
...
function(){return ''+'<span class="num">10: </span>'+'Fire Damage: '+(dec(dec(dec((ln(lvl(56),80,23,39,79,81,83)<<8)*(100+((blvl(36)+blvl(47))*5))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/256,0))+'-'+(dec(dec(dec((ln(lvl(56),100,25,41,81,83,85)<<8)*(100+((blvl(36)+blvl(47))*5))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/256,0))+'<br>'
+'<span class="num">19: </span>'+'Radius: '+dec(6*2/3,1)+' yards<br>'
+'<span class="num">22: </span>'+'Average Fire Damage: '+dec(dec(dec((ln(lvl(56),15,4,5,6)<<3)*(100+(blvl(41)*3))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)*75/256,0)+'-'+dec(dec(dec((ln(lvl(56),25,4,5,6)<<3)*(100+(blvl(41)*3))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)*25/256,0)*3+' per second<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((34+(lvl(56)-1))<<7,1<<8)/256,0),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec(((800+(lvl(57)-1)*200))/25,1),' seconds<br>'])
+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(dec(dec((ln(lvl(57),1,10,10,11)<<8),0)*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'-'+(dec(dec(dec((ln(lvl(57),100,10,10,11)<<8),0)*(100+(50+(lvl(63)-1)*12))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((19<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec(((3600+(lvl(58)-1)*1500))/25,1),' seconds<br>'])
...
+'<span class="num">23: </span>'+cc(['Duration: ',dec((100)/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((23+(lvl(59)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">3: </span>'+'Defense Bonus: '+dec((45+(lvl(60)-1)*5),0)+' percent<br>'
+'<span class="num">12: </span>'+cc(['Duration: ',dec(((3600+(lvl(60)-1)*150)+(blvl(40)+blvl(50))*250)/25,1),' seconds<br>'])
...
function(){return ''+'<span class="num">2: </span>'+cc(['Fire Damage: ',sign(dec((30+(lvl(61)-1)*7),0)),' percent<br>',])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},6,2]
desc[62]=['Hydra',
'summons a multi-headed beast of flame<br>to reduce your enemies to ashes',
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec((250)/25,1),' seconds<br>'])
+'<span class="num">24: </span>'+'Hydra Fire Damage: '+(dec(dec(dec((ln(lvl(62),24,9,13,17,21,25)<<7)*(100+((blvl(36)+blvl(47))*3))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/256,0))+'-'+(dec(dec(dec((ln(lvl(62),34,11,15,19,23,27)<<7)*(100+((blvl(36)+blvl(47))*3))/100,0)*(100+(30+(lvl(61)-1)*7))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((40+(lvl(62)-1))<<7,1<<8)/256,0),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Lightning Damage: ',sign(dec((50+(lvl(63)-1)*12),0)),' percent<br>',])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},6,2]
desc[64]=['Frozen Orb',
...
+'<span class="num">11: </span>'+cc(['Cold Length: ',dec(dec((200+(lvl(64)-1)*25),0)/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((50+(lvl(64)-1))<<7,1<<8)/256,0),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">7: </span>'+dec((20+(lvl(65)-1)*5),0)+' percent<br>'
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},6,2]
