...
+'<span class="num">8: </span>'+cc(['To Attack Rating: +',(10+(lvl(6)-1)*9),' percent<br>'])
+'<span class="num">9: </span>'+cc(['Damage: +',dec((lvl(6)<<8)/256,0),'<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((12+(lvl(6)-1)*-1)<<5,0)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">8: </span>'+cc(['To Attack Rating: +',(10+(lvl(7)-1)*9),' percent<br>'])
...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((24+(lvl(7)-1))<<5,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec(((200+(lvl(8)-1)*100))/25,1),' seconds<br>'])
+'<span class="num">5: </span>'+'Enemy Defense: '+dec(-dec(dec((ln(lvl(8),40,25,45,60,80,100)<<8),0)/256,0),0)+'<br>'
+'<span class="num">19: </span>'+'Radius: '+dec(20*2/3,1)+' yards<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((10<<7)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((10+(lvl(10)-1)*9),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec((-15+(lvl(10)-1)*3),0)),' percent<br>',])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((8+(lvl(10)-1))<<6,1<<8)/256,1),'<br>'])
},
...
function(){return ''+'<span class="num">7: </span>'+dec(min(24,(2+(lvl(12)-1))),0)+' arrows<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((4+(lvl(12)-1))<<8,1<<8)/256,1),'<br>'])
},
...
function(){return ''+'<span class="num">8: </span>'+cc(['To Attack Rating: +',(20+(lvl(14)-1)*12),' percent<br>'])
+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(256/256,0))+'-'+(dec(dec((ln(lvl(14),16,18,36,54,72,90)<<8)*(100+((blvl(34)+blvl(20)+blvl(24)+blvl(35))*10))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((8+(lvl(14)-1))<<6,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">14: </span>'+'Poison Damage: '+(dec((dec(ln(lvl(15),32,16,32,48,64,96)*(100+((blvl(25))*12))/100,0))*(dec((200+(lvl(15)-1)*50),0))/256,0))+'-'+(dec((dec(ln(lvl(15),48,16,36,52,68,84)*(100+((blvl(25))*12))/100,0))*(dec((200+(lvl(15)-1)*50),0))/256,0))+'<br>over '+dec(dec((200+(lvl(15)-1)*50),0)/25,1)+' seconds<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((16+(lvl(15)-1))<<6,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">8: </span>'+cc(['To Attack Rating: +',(20+(lvl(16)-1)*9),' percent<br>'])
...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((10+(lvl(16)-1))<<7,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec(((300+(lvl(17)-1)*150))/25,1),' seconds<br>'])
+'<span class="num">3: </span>'+'Ranged attacks slowed to '+dec(33,0)+' percent<br>'
+'<span class="num">19: </span>'+'Radius: '+dec(20*2/3,1)+' yards<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((10<<7)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec((300+(lvl(19)-1)*25),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((100+(lvl(19)-1)*25),0)),' percent<br>',])
...
function(){return ''+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(256/256,0))+'-'+(dec(dec((ln(lvl(20),40,12,18,28,48,88)<<8)*(100+((blvl(34)+blvl(14)+blvl(24)+blvl(35))*3))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((24+(lvl(20)-1))<<6,1<<8)/256,1),'<br>'])
},
function(){return ''+'<span class="num">73: </span>'+(3)+'/'+(4)+' Weapon Damage<br>'
...
function(){return ''+'<span class="num">8: </span>'+cc(['To Attack Rating: +',(20+(lvl(21)-1)*9),' percent<br>'])
...
+'<span class="num">12: </span>'+cc(['Freezes for ',dec((dec((50+(lvl(21)-1)*5)*(100+((blvl(31))*5))/100,0))/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((16+(lvl(21)-1))<<6,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec(((lvl(22)-1)*5),0)),' percent<br>',])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((32+(lvl(22)-1)*-1)<<6,1<<8)/256,1),'<br>'])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},4,2]
desc[23]=['Penetrate',
'passive - increases your attack rating',
function(){return ''+'<span class="num">2: </span>'+cc(['To Attack Rating: ',sign(dec((35+(lvl(23)-1)*10),0)),' percent<br>',])
},
function(){return ''},
...
+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(256/256,0))+'-'+(dec(dec((ln(lvl(24),30,12,16,20,24,28)<<8)*(100+((blvl(34)+blvl(20)+blvl(14)+blvl(35))*10))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((16+(lvl(24)-1))<<6,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((30+(lvl(25)-1)*9),0)),' percent<br>',])
+'<span class="num">14: </span>'+'Poison Damage: '+(dec((dec((ln(lvl(25),10,6,12,20,40,60)<<3)*(100+((blvl(15))*10))/100,0))*(dec((75+(lvl(25)-1)*10),0))/256,0))+'-'+(dec((dec((ln(lvl(25),16,6,12,20,40,60)<<3)*(100+((blvl(15))*10))/100,0))*(dec((75+(lvl(25)-1)*10),0))/256,0))+'<br>over '+dec(dec((75+(lvl(25)-1)*10),0)/25,1)+' seconds<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((14+(lvl(25)-1))<<7,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((30+(lvl(27)-1)*9),0)),' percent<br>',])
...
+'<span class="num">23: </span>'+cc(['Fire Duration: ',dec((75)/25,1),' seconds<br>'])
+'<span class="num">22: </span>'+'Average Fire Damage: '+dec(dec(((7+(lvl(27)-1)*5)<<2)*(100+(blvl(7)*5))/100,0)*75/256,0)+'-'+dec(dec(((9+(lvl(27)-1)*5)<<2)*(100+(blvl(7)*5))/100,0)*25/256,0)*3+' per second<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((12+(lvl(27)-1))<<7,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">12: </span>'+cc(['Duration: ',dec(((250+(lvl(28)-1)*125))/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((76+(lvl(28)-1)*-3)<<6,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Attack Bonus: ',sign(dec((40+(lvl(30)-1)*10),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec((70+(lvl(30)-1)*10),0)),' percent<br>',])
...
function(){return ''+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((40+(lvl(31)-1)*9),0)),' percent<br>',])
...
+'<span class="num">12: </span>'+cc(['Freezes for ',dec((dec(50*(100+((blvl(21))*5))/100,0))/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((18+(lvl(31)-1))<<7,1<<8)/256,1),'<br>'])
},
...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((25+(lvl(32)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">7: </span>'+dec((2+(lvl(34)-1)),0)+' hits<br>'
+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(256/256,0))+'-'+(dec(dec((ln(lvl(34),25,10,15,20,25,30)<<8)*(100+((blvl(24)+blvl(20)+blvl(14)+blvl(35))*8))/100,0)/256,0))+'<br>'
...
function(){return ''+'<span class="num">3: </span>'+'Releases '+dec((2+(lvl(35)-1)),0)+' bolts<br>'
+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(256/256,0))+'-'+(dec(dec((ln(lvl(35),40,20,30,40,50)<<8)*(100+((blvl(24)+blvl(20)+blvl(14)+blvl(34))*1))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((20+(lvl(35)-1))<<7,1<<8)/256,1),'<br>'])
},
function(){return ''},
