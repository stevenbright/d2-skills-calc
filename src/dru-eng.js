...
function(){return ''+'<span class="num">9: </span>'+'Damage: '+dec(((2+(lvl(221)-1))<<8)/256,0)+'-'+dec(((4+(lvl(221)-1))<<8)/256,0)+'<br>'
+'<span class="num">7: </span>'+dec((12+(lvl(221)-1)),0)+' hits<br>'
+'<span class="num">5: </span>'+'Ravens: '+dec(min(lvl(221),5),0)+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost Per Raven: ',dec((6<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">14: </span>'+'Poison Damage: '+(dec((dec(ln(lvl(222),12,7,12,15,17,19),0))*(dec(100,0))/256,0))+'-'+(dec((dec(ln(lvl(222),16,7,12,15,17,19),0))*(dec(100,0))/256,0))+'<br>over '+dec(dec(100,0)/25,1)+' seconds<br>'
...
function(){return ''+'<span class="num">2: </span>'+cc(['To Attack Rating: ',sign(dec((50+(lvl(223)-1)*15),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Attack Speed: ',sign(dec(dm(lvl(223),10,80),0)),' percent<br>',])
},
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((15<<8)/256,1),'<br>'])
+'<span class="num">2: </span>'+cc(['Life: ',sign(dec(25+(20+(lvl(224)-1)*5),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Stamina Bonus: ',sign(dec(25,0)),' percent<br>',])
+'<span class="num">12: </span>'+cc(['Duration: ',dec((1000+(1000+(lvl(224)-1)*500))/25,1),' seconds<br>'])
},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Max Life: ',sign(dec((20+(lvl(224)-1)*5),0)),' percent<br>',])
+'<span class="num">57: </span>'+'Duration: +'+((1000+(lvl(224)-1)*500))/25+' seconds<br>'
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},1,2]
desc[225]=['Firestorm',
...
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((4<<8)/256,1),'<br>'])
},
...
+'<span class="num">2: </span>'+cc(['Life: ',sign(dec((30+(lvl(226)-1)*5),0)),' percent<br>',])
+'<span class="num">19: </span>'+'Radius: '+dec(dec((30+(lvl(226)-1)*2),0)*2/3,1)+' yards<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((15+(lvl(226)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">9: </span>'+'Damage: '+dec((ln(lvl(227),2,1,2,4,5,8)<<8)*(100+(25+(lvl(247)-1)*10))/25600,0)+'-'+dec((ln(lvl(227),6,1,2,4,5,8)<<8)*(100+(25+(lvl(247)-1)*10))/25600,0)+'<br>'
+'<span class="num">5: </span>'+'Wolves: '+dec(min(lvl(227),5),0)+'<br>'
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((50+(lvl(227)-1)*25),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Defense: ',sign(dec((50+(lvl(227)-1)*10),0)),' percent<br>',])
},
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((15<<8)/256,1),'<br>'])
+'<span class="num">13: </span>'+'Life: '+dec(60*(100+((lvl(237)>0)?(50+(lvl(237)-1)*25):0))/100+(0),0)+-+dec(82*(100+((lvl(237)>0)?(50+(lvl(237)-1)*25):0))/100+(0),0)+'<br>'
},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec((50+(lvl(228)-1)*7),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Defense: ',sign(dec((25+(lvl(228)-1)*5),0)),' percent<br>',])
},
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((15<<8)/256,1),'<br>'])
+'<span class="num">2: </span>'+cc(['Life: ',sign(dec(50+(20+(lvl(224)-1)*5),0)),' percent<br>',])
+'<span class="num">12: </span>'+cc(['Duration: ',dec((1000+(1000+(lvl(224)-1)*500))/25,1),' seconds<br>'])
},
...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((20+(lvl(229)-1))<<7,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">11: </span>'+cc(['Cold Length: ',dec(dec((100+(lvl(230)-1)*15),0)/25,1),' seconds<br>'])
+'<span class="num">19: </span>'+'Range: '+dec(dec((35+(lvl(230)-1)*2)/4,0)*2/3,1)+' yards<br>'
+'<span class="num">3: </span>'+'Mana Cost: '+dec(dec(max((24+(lvl(230)-1))<<2,0)/20.48,0),0)+' per second<br>'
},
...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((10<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec((50+(lvl(232)-1)*5),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((20+(lvl(232)-1)*10),0)),' percent<br>',])
},
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((3<<8)/256,1),'<br>'])
...
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((20+(lvl(233)-1)*10),0)),' percent<br>',])
},
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((3<<8)/256,1),'<br>'])
+'<span class="num">12: </span>'+cc(['Duration: ',dec((500)/25,1),' seconds<br>'])
},
...
+'<span class="num">23: </span>'+cc(['Duration: ',dec((80)/25,1),' seconds<br>'])
},
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((15<<8)/256,1),'<br>'])
},
...
function(){return ''+'<span class="num">3: </span>'+'Absorbs '+dec(((40+(lvl(235)-1)*12)*(100+(blvl(240)+blvl(245)+blvl(250))*7)/100),0)+' damage<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((5+(lvl(235)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec((20+(lvl(236)-1)*7),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((25+(lvl(236)-1)*7),0)),' percent<br>',])
+'<span class="num">19: </span>'+'Radius: '+dec(dec((30+(lvl(236)-1)*2),0)*2/3,1)+' yards<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((20+(lvl(236)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">13: </span>'+'Life: '+dec(98*(100+((50+(lvl(237)-1)*25)))/100+(0),0)+-+dec(130*(100+((50+(lvl(237)-1)*25)))/100+(0),0)+'<br>'
+'<span class="num">9: </span>'+'Damage: '+dec((ln(lvl(237),7,2,3,6,8,11)<<8)*(100+(25+(lvl(247)-1)*10))/25600,0)+'-'+dec((ln(lvl(237),12,2,3,6,9,13)<<8)*(100+(25+(lvl(247)-1)*10))/25600,0)+'<br>'
+'<span class="num">5: </span>'+'Wolves: '+dec(min(lvl(237),3),0)+'<br>'
+'<span class="num">2: </span>'+cc(['Life: ',sign(dec((50+(lvl(237)-1)*25),0)),' percent<br>',])
},
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((20<<8)/256,1),'<br>'])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((50+(lvl(227)-1)*25),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Defense: ',sign(dec((50+(lvl(227)-1)*10),0)),' percent<br>',])
},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((50+(lvl(238)-1)*7),0)),' percent<br>',])
+'<span class="num">14: </span>'+'Poison Damage: '+(dec((dec((ln(lvl(238),6,4,5,7,11,16)<<3)*(100+((blvl(222))*18))/100,0))*(dec((100+(lvl(238)-1)*10),0))/256,0))+'-'+(dec((dec((ln(lvl(238),14,4,5,7,11,16)<<3)*(100+((blvl(222))*18))/100,0))*(dec((100+(lvl(238)-1)*10),0))/256,0))+'<br>over '+dec(dec((100+(lvl(238)-1)*10),0)/25,1)+' seconds<br>'
},
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((10<<8)/256,1),'<br>'])
},
...
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((50+(lvl(239)-1)*15),0)),' percent<br>',])
...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((14+(lvl(241)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((50+(lvl(242)-1)*10),0)),' percent<br>',])
...
function(){return ''+'<span class="num">12: </span>'+cc(['Stun Length: ',dec(((40+(lvl(243)-1)*15))/25,1),' seconds<br>'])
...
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((25<<8)/256,1),'<br>'])
},
...
+'<span class="num">7: </span>'+dec((50+(lvl(246)-1)*20),0)+' percent damage returned<br>'
+'<span class="num">19: </span>'+'Radius: '+dec(dec((30+(lvl(246)-1)*2),0)*2/3,1)+' yards<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((25+(lvl(246)-1))<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},6,1]
desc[247]=['Summon Grizzly',
'summon a ferocious grizzly bear',
function(){return ''+'<span class="num">9: </span>'+'Damage: '+dec((ln(lvl(247),30,10,15,20,26,30)<<8)*(100+(25+(lvl(247)-1)*10))/25600,0)+'-'+dec((ln(lvl(247),60,10,15,20,26,30)<<8)*(100+(25+(lvl(247)-1)*10))/25600,0)+'<br>'
+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec((25+(lvl(247)-1)*10),0)),' percent<br>',])
},
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((40<<8)/256,1),'<br>'])
+'<span class="num">13: </span>'+'Life: '+dec(550*(100+((50+(lvl(237)-1)*25)))/100+(0),0)+-+dec(750*(100+((50+(lvl(237)-1)*25)))/100+(0),0)+'<br>'
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((50+(lvl(227)-1)*25),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Defense: ',sign(dec((50+(lvl(227)-1)*10),0)),' percent<br>',])
},
...
+'<span class="num">2: </span>'+cc(['Attack Bonus: ',sign(dec((50+(lvl(248)-1)*7),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec((100+(lvl(248)-1)*17),0)),' percent<br>',])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((4<<8)/256,1),'<br>'])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},6,1]
...
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec((250+blvl(234)*50)/25,1),' seconds<br>'])
...
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec((250+blvl(235)*50)/25,1),' seconds<br>'])
+'<span class="num">19: </span>'+'Radius: '+dec(9*2/3,1)+' yards<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((30<<8)/256,1),'<br>'])
},
