...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((24+(lvl(251)-1))<<5,1<<8)/256,1),'<br>'])
},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec((35+(lvl(252)-1)*4),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((30+(lvl(252)-1)*10),0)),' percent<br>',])
...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((16+(lvl(253)-1))<<6,1<<8)/256,2),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Charge 1 - ',sign(dec((100+(lvl(254)-1)*20),0)),' percent damage<br>',])
+'<span class="num">2: </span>'+cc(['Charge 2 - ',sign(dec(2*(100+(lvl(254)-1)*20),0)),' percent damage<br>',])
+'<span class="num">2: </span>'+cc(['Charge 3 - ',sign(dec(3*(100+(lvl(254)-1)*20),0)),' percent damage<br>',])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((15+(lvl(254)-1)*7),0)),' percent<br>',])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((1<<8)/256,1),'<br>'])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},1,2]
...
+'<span class="num">2: </span>'+cc(['Kick Damage: ',sign(dec((5+(lvl(255)-1)*7),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((20+(lvl(255)-1)*25),0)),' percent<br>',])
...
+'<span class="num">23: </span>'+cc(['Duration: ',dec((90)/25,1),' seconds<br>'])
+'<span class="num">38: </span>'+'Lightning Damage: '+dec(dec(256/256,0),0)+'-'+dec(dec(dec((ln(lvl(256),20,6,12,20,30,42)<<7)*(100+((blvl(261)+blvl(271)+blvl(276))*11))/100,0)/256,0),0)+' per second<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((6<<8)/256,1),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec(((100+(lvl(257)-1)*12))/25,1),' seconds<br>'])
...
function(){return ''+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((7<<8)/256,1),'<br>'])
},
...
+'<span class="num">12: </span>'+cc(['Duration: ',dec(((3000+(lvl(258)-1)*300))/25,1),' seconds<br>'])
...
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((15+(lvl(259)-1)*7),0)),' percent<br>',])
...
function(){return ''+'<span class="num">2: </span>'+cc(['Damage: ',sign(dec((50+(lvl(260)-1)*5),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((40+(lvl(260)-1)*25),0)),' percent<br>',])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((2<<8)/256,1),'<br>'])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},2,3]
...
function(){return ''+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(256/256,0))+'-'+(dec(dec((ln(lvl(261),14,6,8,12,14,16)<<7)*(100+((blvl(251)+blvl(271)+blvl(276))*6))/100,0)/256,0))+'<br>'
},
function(){return ''+'<span class="num">3: </span>'+'Shoots '+dec(5+blvl(271)/4,0)+' Times<br>'
+'<span class="num">3: </span>'+'Releases '+dec(5+blvl(256)/3,0)+' charged bolts<br>'
...
function(){return ''+'<span class="num">12: </span>'+cc(['Duration: ',dec(((200+(lvl(264)-1)*25))/25,1),' seconds<br>'])
+'<span class="num">2: </span>'+cc(['Defense Bonus: ',sign(dec((10+(lvl(264)-1)*3),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Enemy Defense: ',sign(dec(-min((15+(lvl(264)-1)*3),95),0)),' percent<br>',])
},
...
function(){return ''+'<span class="num">2: </span>'+cc(['Charge 1 - ',sign(dec((40+(lvl(265)-1)*5),0)),' percent life stealing<br>',])
+'<span class="num">2: </span>'+cc(['Charge 2 - ',sign(dec((40+(lvl(265)-1)*5),0)),' percent life and mana stealing <br>',])
+'<span class="num">2: </span>'+cc(['Charge 3 - ',sign(dec(2*(40+(lvl(265)-1)*5),0)),' percent life and mana stealing <br>',])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((15+(lvl(265)-1)*7),0)),' percent<br>',])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((2<<8)/256,1),'<br>'])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},3,2]
...
+'<span class="num">61: </span>'+'Mana Cost: '+dec((max((8+(lvl(266)-1))<<5,0))/256,1)+' per blade<br>'
},
...
+'<span class="num">12: </span>'+cc(['Duration: ',dec(((3000+(lvl(267)-1)*300))/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((10<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((54+(lvl(268)-1))<<7,1<<8)/256,0),'<br>'])
},
function(){return ''},
...
function(){return ''+'<span class="num">24: </span>'+'Charge 1 - lightning damage: '+(dec(256/256,0))+'-'+(dec(dec((ln(lvl(269),80,20,40,60,80,100)<<8)*(100+((blvl(280))*8))/100,0)/256,0))+'<br>'
+'<span class="num">62: </span>'+'Charge 2 - nova damage: '+(dec(dec((1<<8)*(100+((blvl(280))*8))/100,0)/256,0))+'-'+(dec(dec((ln(lvl(269),30,15,25,35,45,65)<<8)*(100+((blvl(280))*8))/100,0)/256,0))+'<br>'
+'<span class="num">62: </span>'+'Charge 3 - charged bolt damage: '+(dec(dec((1<<8)*(100+((blvl(280))*8))/100,0)/256,0))+'-'+(dec(dec((ln(lvl(269),40,20,40,60,80,100)<<8)*(100+((blvl(280))*8))/100,0)/256,0))+'<br>'
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((15+(lvl(269)-1)*7),0)),' percent<br>',])
...
function(){return ''+'<span class="num">2: </span>'+cc(['fire damage: ',sign(dec((50+(lvl(270)-1)*10),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((20+(lvl(270)-1)*15),0)),' percent<br>',])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((10<<8)/256,1),'<br>'])
},
...
function(){return ''+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(256/256,0))+'-'+(dec(dec((ln(lvl(271),20,10,16,24,34,44)<<8)*(100+((blvl(256)+blvl(261)+blvl(276))*12))/100,0)/256,0))+'<br>'
...
+'<span class="num">12: </span>'+cc(['Stun Length: ',dec((min(250,dec((50+(lvl(273)-1)*5),0)))/25,1),' seconds<br>'])
...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((15<<8)/256,1),'<br>'])
},
...
+'<span class="num">12: </span>'+cc(['Charge 3 - freeze duration: ',dec((dec((100+(lvl(274)-1)*10),0))/25,1),' seconds<br>'])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((15+(lvl(274)-1)*7),0)),' percent<br>',])
...
function(){return ''+'<span class="num">2: </span>'+cc(['Kick Damage: ',sign(dec((100+(lvl(275)-1)*25),0)),' percent<br>',])
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((60+(lvl(275)-1)*25),0)),' percent<br>',])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((15<<8)/256,1),'<br>'])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},5,3]
...
+'<span class="num">10: </span>'+'Lightning Damage: '+(dec(256/256,0))+'-'+(dec(dec((ln(lvl(276),50,8,14,22,28,34)<<8)*(100+((blvl(271))*12))/100,0)/256,0))+'<br>'
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((20<<8)/256,1),'<br>'])
},
...
+'<span class="num">12: </span>'+cc(['Duration: ',dec(((500+(lvl(277)-1)*125))/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((27+(lvl(277)-1)*2)<<8,1<<8)/256,1),'<br>'])
},
function(){return ''},
function(){return ''+'<span class="green">'+'</span>'},6,3]
desc[278]=['Venom',
'add poison damage to your weapons',
function(){return ''+'<span class="num">14: </span>'+'Poison Damage: '+(dec((dec((ln(lvl(278),24,6,8,10,12,14)<<6),0))*(dec(10,0))/256,0))+'-'+(dec((dec((ln(lvl(278),32,6,8,10,12,14)<<6),0))*(dec(10,0))/256,0))+'<br>over '+dec(dec(10,0)/25,1)+' seconds<br>'
+'<span class="num">12: </span>'+cc(['Duration: ',dec(((3000+(lvl(278)-1)*100))/25,1),' seconds<br>'])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((12<<8)/256,1),'<br>'])
},
function(){return ''},
...
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec(max((70+(lvl(279)-1))<<7,1<<8)/256,0),'<br>'])
},
function(){return ''},
...
+'<span class="num">62: </span>'+'Charge 2 - chain lightning damage: '+(dec(dec((1<<8)*(100+((blvl(269))*13))/100,0)/256,0))+'-'+(dec(dec((ln(lvl(280),40,20,40,60,80,100)<<8)*(100+((blvl(269))*13))/100,0)/256,0))+'<br>'
...
+'<span class="num">2: </span>'+cc(['Attack: ',sign(dec((15+(lvl(280)-1)*7),0)),' percent<br>',])
+'<span class="num">1: </span>'+cc(['Mana Cost: ',dec((4<<8)/256,1),'<br>'])
},
function(){return ''},
